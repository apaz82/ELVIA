...
- **Data Layers**: `profiles`, `cv_results`, `job_checks`, `saved_jobs`, `administrators`, and `linkedin_analyses` (historial persistente).
...
*Log automatically updated by Antigravity on 2026-05-03.*
