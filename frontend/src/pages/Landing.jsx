    ...
    <div className="min-h-screen bg-slate-50 font-body text-gray-900 selection:bg-[#E8541A]/20 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 bg-gray-900/50">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-white">Desarrollada por expertos en atracción de talento y mentores de carrera</span>
            </div>
            ...
            >
              ...
              <div className="relative bg-[#0A1A14]/90 backdrop-blur-xl border border-white/10 p-4 sm:p-6 rounded-[2rem] sm:rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                <div className="flex items-center gap-4 border-b border-white/10 pb-5 mb-5">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-teal-400 to-emerald-600 p-[1.5px] shadow-lg overflow-hidden flex items-center justify-center">
      ...
      <section id="features-section" className="relative z-10 py-24 px-6 bg-slate-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="hidden md:block relative mx-auto" style={{ maxWidth: '700px', height: '700px' }}>
            {/* Anillo de órbita */}
            <div
            ...
            <div className="lg:col-span-2 text-center lg:text-left space-y-8">
              <div className="flex flex-col items-center lg:items-start gap-6">
                ...
                <div className="relative inline-block">
                  ...
                  <div className="relative w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded-full border-2 border-white/10 shadow-2xl bg-[#0A3D2A] flex items-center justify-center">
                    <img 
